...
<body>
<form action="/updatedm?id=<?php echo $dmsua['0']->id; ?>" method="POST" name="frm" onsubmit="return kiemtra()">
	{{ csrf_field() }}
	<table>
		...
		<tr>
			<td>Mã danh mục</td>
			<td><input type="text" disabled="disabled" name="id" size="5" value="<?php echo $dmsua['0']->id; ?>" /></td>
		</tr>
		<tr>
			<td>Tên danh mục</td>
			<td><input type="text" name="tendm" value="<?php echo $dmsua['0']->tendm; ?>" /> </td>
		</tr>
		<tr>
			<td>Thuộc</td>
				<td>
		...
		<tr>
				<td colspan=2 class="input"> <input type="submit" name="update" value="Sửa" />
